public class Metody {
    ...
    public int pobierzWynik() {
        ...
        System.out.println("Rezultat to: " + result);
        return result;                                //return dajemy w intach, w voidach nie
    }
    public void polliczWynikParam(int number) {
    ...
    public int add(int firstNumber, int secondNumber, String word) {
        ...
        return firstNumber + secondNumber;           //return dajemy w intach, w voidach nie
